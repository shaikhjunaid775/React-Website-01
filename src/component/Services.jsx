...
function Services() {
  const [open, setOpen] = useState("tab1");
  ...
  return (
    <>
      <section className=" dark:bg-gray-900 bg-gray-200 dark:text-gray-300 text-gray-600 lg:pb-[120px]">
        <div className="container mx-auto">
          <div className="w-full overflow-x-auto no-scrollbar ">
            <ul className="flex justify-between md:grid grid-flow-col gap-3 text-center shadow-sm bg-gray-100 dark:bg-gray-700 rounded-full p-1 overflow-auto md:overflow-hidden whitespace-nowrap">
              {[
                { id: "tab1", label: "Pilot Training" },
                { id: "tab2", label: "Titan Maintenance" },
                { id: "tab3", label: "Loadout" },
                { id: "tab4", label: "Server Browser" }
              ].map((tab, index) => (
                <li key={tab.index} className="relative">
                  {open === tab.id && (
                    <motion.div
                      layoutId="activeTab"
                  ...
                  <motion.span
                    ...
                    className={`relative cursor-pointer flex g justify-center py-2 whitespace-nowrap md:py-2 px-2 md:px-6 rounded-full transition-all duration-300 text-xs font-bold ${
                      open === tab.id
                        ? "text-sky-500 "
          ...
          <div className="container px-6 py-10 mx-auto">
            <div className="lg:flex lg:items-center">
              <div className="w-full space-y-12 lg:w-1/2 ">
                <div>
                  <span className="text-xl md:text-3xl font-semibold text-gray-800 capitalize dark:text-white">
                ...
                <div className="md:flex md:items-start md:-mx-4">
                  <span className="inline-block p-2 text-blue-500 bg-blue-200 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                    <svg
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    <span className="text-lg md:text-xl  font-semibold text-gray-700 capitalize dark:text-white">
